                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {/* LinkedIn Proof */}
                      {exp.linkedin && (
                        <div className="flex shrink-0 mt-4 pt-4 border-t border-cyber-blue/10 justify-center md:justify-start">
                          <a
                            href={exp.linkedin}
                            target="_blank"
                            rel="noopener noreferrer"
                            draggable={false}
                            title="View LinkedIn Documentation"
                            className="flex items-center justify-center p-3 sm:p-2.5 border rounded-lg transition-all duration-300 hover:bg-cyber-blue/5"
                            style={{
                              borderColor: `${config.color}50`,
                              color: config.color,
                            }}
                            onMouseEnter={(e) => {
                               e.currentTarget.style.boxShadow = `0 0 15px ${config.color}60`;
